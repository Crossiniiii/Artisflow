...
- Name: tmp\e2e-findings.spec.cjs >> manual return from framer stores a blob URL in the transfer record
- Location: tmp\e2e-findings.spec.cjs:93:1
...
Call log:
  - waiting for getByRole('button', { name: 'For Framing', exact: true })
